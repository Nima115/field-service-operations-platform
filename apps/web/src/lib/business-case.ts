export const clientCase = {
  ...
  metrics: [
    ...
    { label: "Customer history", value: "Centralized" }
  ],
  workflows: [
    "Customer creates a service booking",
    "Admin confirms request and assigns employee",
    "Employee completes the job with notes and uploads",
    "Finance generates invoice from booking",
    "Leadership reviews revenue and service trends"
  ]
};
